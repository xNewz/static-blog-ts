...
description: ในบทความนี้เราจะสอนวิธีการสร้าง API สำหรับการจัดการข้อมูลนักศึกษา (student) โดยใช้ Node.js, Express, และ MongoDB เป็น API ที่สามารถสร้างข้อมูล, อ่านข้อมูล, อัปเดตข้อมูล, และลบข้อมูลของนักศึกษาได้ด้วย HTTP requests.
date: 2024-05-01
published: true
---
